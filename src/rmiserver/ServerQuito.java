...
public class ServerQuito extends UnicastRemoteObject implements RMIInterface {

	private static final long serialVersionUID = 1L;
	
	protected ServerQuito() throws RemoteException {
	...
	public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerQuito", new ServerQuito());
