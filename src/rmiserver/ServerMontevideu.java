...
public class ServerMontevideu extends UnicastRemoteObject implements RMIInterface {

	private static final long serialVersionUID = 1L;
	
	protected ServerMontevideu() throws RemoteException {
	...
	public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerMontevideu", new ServerMontevideu());
