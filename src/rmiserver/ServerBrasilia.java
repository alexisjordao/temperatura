...
public class ServerBrasilia extends UnicastRemoteObject implements RMIInterface {

	private static final long serialVersionUID = 1L;
	
	protected ServerBrasilia() throws RemoteException {
	...
	public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerBrasilia", new ServerBrasilia());
