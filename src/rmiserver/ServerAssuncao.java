...
public class ServerAssuncao extends UnicastRemoteObject implements RMIInterface {

	private static final long serialVersionUID = 1L;
	
	protected ServerAssuncao() throws RemoteException {
	...
	public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerAssuncao", new ServerAssuncao());
