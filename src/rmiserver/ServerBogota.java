...
public class ServerBogota extends UnicastRemoteObject implements RMIInterface {

	private static final long serialVersionUID = 1L;
	
	protected ServerBogota() throws RemoteException {
	...
	public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerBogota", new ServerBogota());
